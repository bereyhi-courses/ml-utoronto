...
description: We show that maximal representation variance is given by principal components of the sample covariance matrix. We further take a look at PCA applications, and its interpretation as maximum likelihood estimation. 
videoID: A0mW0exMOm8
hide_from_announcments: false
---
**Lecture Notes:**
- [Lecture 5]({{ site.baseurl }}/assets/Notes/Lecture5.pdf)

...
description: We study the problem of dimensionality reduction. We investigate linear approach which leads to PCA algorithm. We review some notions in linear algebra, and see how this problem can be interpreted as a learning task. 
videoID: N0sDEb4nvgo 
hide_from_announcments: false
---
**Lecture Notes:**
- [Lecture 4]({{ site.baseurl }}/assets/Notes/Lecture4.pdf)
